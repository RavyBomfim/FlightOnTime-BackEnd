...
public record FlightRequestDTO(
                ...
                @NotBlank(message = "O aeroporto de destino é obrigatório") @Size(min = 4, max = 4, message = "O código do aeroporto de destino deve ter 4 caracteres") @JsonProperty("destino") String destination,

                @NotNull(message = "A data de partida é obrigatória") @JsonProperty("data_partida") LocalDateTime scheduledDeparture) {
}
